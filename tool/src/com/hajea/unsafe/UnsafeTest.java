...
//		
//		Field mFiled = clazz.getDeclaredField("m");
//		Money money = (Money) mFiled.get(target);
//		System.out.println("原始值是:" + money);
//		
//		Money m = new Money();
//		unsafe.compareAndSwapObject(target, 32, money, m );
//		
//		
//		mFiled = clazz.getDeclaredField("m");
//		money = (Money) mFiled.get(target);
//		System.out.println("改变之后的值是:" + money);
//	}
//}
//
//class Target {
