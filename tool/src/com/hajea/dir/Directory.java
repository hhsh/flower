...
public final class Directory {
	...
	public static void recurseDelete(File startFile){
		TreeInfo fileDirectory=Directory.walk(startFile);
		System.out.println(fileDirectory);
		//must first delete file,then dir
		List<File> FileList=fileDirectory.files;
		for(int i=0;i<FileList.size();i++) {
			FileList.get(i).delete();
		}
		 
		List<File> dirList=fileDirectory.dirs;
